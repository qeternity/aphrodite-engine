...
class ModelRunner:
    ...
    def prepare_input_tensors(
        ...
        if self.is_driver_worker:
            ...
            # TODO: Combine the broadcasts or set async_op=True.
            ...
            if sampling_metadata.persistent_metadata is not None:
                broadcast_object_list([sampling_metadata.persistent_metadata],
                                      src=0)
        else:
            receving_list = [None]
